// ====== 交易分类管理 ======
const DEFAULT_CATEGORIES = ['餐饮','交通','转账','居住','数码','服饰','娱乐','教育','亲友代付','红包','医疗','日用','旅行','其他'];

// 预定义的分类别名映射（可按需扩展）
const DEFAULT_CATEGORY_ALIASES = {
  '餐饮': ['饭','吃饭','餐饮美食','外卖','餐馆','午餐','晚餐','早餐','餐厅','扫二维码付款','商户消费'],
  '交通': ['地铁','公交','打车','出租','滴滴','交通费','燃油','交通出行'],
  '居住': ['房租','租金','物业','水电','燃气','房贷','家居家装'],
  '数码': ['电子','手机','电脑','平板','数码产品','配件'],
  '服饰': ['衣服','鞋子','服装','配饰','帽子','服饰装扮'],
  '娱乐': ['电影','游戏','KTV','聚会','演出','娱乐消费','文化休闲','母婴亲子'],
  '教育': ['培训','学费','课程','教材','讲座'],
  '转账': ['转账','转账支出','转账收入','信用借还'],
  '亲友代付': ['代付','朋友代付','亲友代付'],
  '医疗': ['医院','诊所','药品','药店','体检','医疗费','保险'],
  '日用': ['日用品','日用百货','超市','便利店','生活用品'],
  '旅行': ['机票','酒店','旅行','旅游','景点'],
  '红包': ['红包','微信红包（单发）','微信红包（群发）','微信红包','红包钱','转账红包'],
  '其他': []
};
